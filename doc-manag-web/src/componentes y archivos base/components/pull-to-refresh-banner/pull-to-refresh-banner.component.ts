...
@Component({
  selector: "app-pull-to-refresh-banner",
  templateUrl: "./pull-to-refresh-banner.component.html",
  styleUrls: ["./pull-to-refresh-banner.component.scss"],
  standalone: true,
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [IconComponent, ButtonComponent],
})
export class PullToRefreshBannerComponent {
